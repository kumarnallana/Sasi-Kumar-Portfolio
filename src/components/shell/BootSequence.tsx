...
const DIAG_LINES = [
  "mounting React / Next interface",
  "linking Node / Express services",
  "initializing Python API layer",
  "mapping SQL / SQLAlchemy persistence",
  "indexing verified project systems",
  "synchronizing GitHub signals",
];
...
function memoryLine(): string {
  ...
  try {
    const raw = localStorage.getItem("nsk-visit");
